<template>
	<div class="container">
		<form ref="form" novalidate :class="{'was-validated': validated}">
			...
			<div class="text-right" v-if="decryptingMode">
				<button type="button" class="ml-2 btn btn-danger" @click.prevent="wipe()">Delete Encrypted Accounts</button>
				<button type="submit" class="ml-2 btn btn-primary" @click.prevent="save()">Submit Encryption Key</button>
			</div>
